/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: faa2f371812dfc96e25069642083642f)
// Runtime types generated with workerd@1.20250927.0 2025-05-09 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		RAG_INSTANCE_NAME: "toolhouse-rag";
		TOOLHOUSE_API_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RAG_INSTANCE_NAME" | "TOOLHOUSE_API_URL" | "GEMINI_API_KEY" | "GEMINI_MODEL">> {}
}
